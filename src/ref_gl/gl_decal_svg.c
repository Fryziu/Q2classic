...
"<svg width='64' height='64' viewBox='0 0 128 128' xmlns='http://www.w3.org/2000/svg'>"
  "<defs>"
    ...
    "<radialGradient id='grad_heat' cx='50%' cy='50%' r='50%'>"
      "<stop offset='0%' stop-color='#636363' stop-opacity='0.4' />"
      "<stop offset='50%' stop-color='#272727' stop-opacity='0.1' />"
    ...
    "<radialGradient id='grad_slag' cx='50%' cy='50%' r='50%' fx='35%' fy='35%'>"
      "<stop offset='0%' stop-color='#676767' stop-opacity='0.6' />"
      "<stop offset='50%' stop-color='#383838' stop-opacity='0.4' />"
      "<stop offset='85%' stop-color='#2d2d2d' stop-opacity='0.2' />"
    ...
    "<radialGradient id='grad_glow' cx='50%' cy='50%' r='50%'>"
      ...
      "<stop offset='15%' stop-color='#bdbdbd' stop-opacity='1' />"
      "<stop offset='40%' stop-color='#757575' stop-opacity='0.9' />"
      "<stop offset='75%' stop-color='#4b4b4b' stop-opacity='0.6' />"
  ...
  "<path d='M64,24 C88,20 104,36 108,56 C112,76 96,104 72,108 C48,112 24,96 20,72 C16,48 36,28 64,24 Z' fill='#0a0502' opacity='0.4' />"
  ...
  "<circle cx='90' cy='30' r='5' fill='url(#grad_glow)' opacity='0.8' />"
  "<circle cx='25' cy='80' r='3' fill='url(#grad_glow)' opacity='0.7' />"
  "<circle cx='55' cy='105' r='6' fill='url(#grad_glow)' opacity='0.7' />"
"</svg>";
