...
void gladiator_stand (edict_t *self)
{
	self->monsterinfo.currentmove = &gladiator_move_stand;
	    self->monsterinfo.currentmove_name = "gladiator_move_stand";
}
...
void gladiator_walk (edict_t *self)
{
	self->monsterinfo.currentmove = &gladiator_move_walk;
	    self->monsterinfo.currentmove_name = "gladiator_move_walk";
}
...
void gladiator_run (edict_t *self)
{
	...
	else
	{
	    ...
	    self->monsterinfo.currentmove_name = "gladiator_move_run";
	}
}
...
void gladiator_melee(edict_t *self)
{
	self->monsterinfo.currentmove = &gladiator_move_attack_melee;
	    self->monsterinfo.currentmove_name = "gladiator_move_attack_melee";
}
...
void gladiator_attack(edict_t *self)
{
	...
	self->monsterinfo.currentmove = &gladiator_move_attack_gun;
	    self->monsterinfo.currentmove_name = "gladiator_move_attack_gun";
}
...
void gladiator_pain (edict_t *self, edict_t *other, float kick, int damage)
{
	...
	if (level.time < self->pain_debounce_time)
	{
		if ((self->velocity[2] > 100) && (self->monsterinfo.currentmove == &gladiator_move_pain))
		{
			...
			self->monsterinfo.currentmove_name = "gladiator_move_pain_air";
		}
		return;
	}
	...
	else
	{
	    ...
	    self->monsterinfo.currentmove_name = "gladiator_move_pain";
	}
...
// regular death
	...
	self->monsterinfo.currentmove = &gladiator_move_death;
	    self->monsterinfo.currentmove_name = "gladiator_move_death";
}
